...
const Menu = () => {
  ...
  const [currentIndex, setCurrentIndex] = useState(0);
    ...
    useGSAP(()=>{
        ...
        gsap.fromTo('.details h2', {yPercent: 100, opacity:0}, {yPercent: 0, opacity: 1, ease: 'power1.inOut', duration: 1, delay: 0.5,})
        gsap.fromTo('.details p', {yPercent: 100, opacity:0}, {yPercent: 0, opacity: 1, ease: 'power1.inOut', duration: 1, delay: 0.5,})
    },[currentIndex]);
